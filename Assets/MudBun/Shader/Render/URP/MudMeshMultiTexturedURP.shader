	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 temp_output_167_0_g247 = vertexToFrag213;
				float3 temp_output_44_0_g253 = ( appendResult258 * abs( temp_output_167_0_g247 ) );
				float3 break14_g253 = temp_output_44_0_g253;
				float3 temp_output_166_0_g247 = vertexToFrag212;
				float3 temp_output_36_0_g253 = temp_output_166_0_g247;
				float4 appendResult23_g253 = (float4(temp_output_44_0_g253 , 0.0));
				float4 appendResult24_g253 = (float4(temp_output_44_0_g253 , 1.0));
				float4 break10_g254 = ( ( break14_g253.x + break14_g253.y + break14_g253.z ) > 0.0 ? appendResult23_g253 : appendResult24_g253 );
				float4 color20_g253 = IsGammaSpace() ? float4(1,1,1,0) : float4(1,1,1,0);
				float4 break10_g252 = vertexToFrag224;
				float3 appendResult251 = (float3(_Norm1X , _Norm1Y , _Norm1Z));
				float3 temp_output_44_0_g255 = ( appendResult251 * abs( temp_output_167_0_g247 ) );
				float3 break14_g255 = temp_output_44_0_g255;
				float3 temp_output_36_0_g255 = temp_output_166_0_g247;
				float4 appendResult23_g255 = (float4(temp_output_44_0_g255 , 0.0));
				float4 appendResult24_g255 = (float4(temp_output_44_0_g255 , 1.0));
				float4 break10_g256 = ( ( break14_g255.x + break14_g255.y + break14_g255.z ) > 0.0 ? appendResult23_g255 : appendResult24_g255 );
				float4 color20_g255 = IsGammaSpace() ? float4(1,1,1,0) : float4(1,1,1,0);
				float3 appendResult259 = (float3(_Norm2X , _Norm2Y , _Norm2Z));
				float3 temp_output_44_0_g248 = ( appendResult259 * abs( temp_output_167_0_g247 ) );
				float3 break14_g248 = temp_output_44_0_g248;
				float3 temp_output_36_0_g248 = temp_output_166_0_g247;
				float4 appendResult23_g248 = (float4(temp_output_44_0_g248 , 0.0));
				float4 appendResult24_g248 = (float4(temp_output_44_0_g248 , 1.0));
				float4 break10_g249 = ( ( break14_g248.x + break14_g248.y + break14_g248.z ) > 0.0 ? appendResult23_g248 : appendResult24_g248 );
				float4 color20_g248 = IsGammaSpace() ? float4(1,1,1,0) : float4(1,1,1,0);
				float3 appendResult257 = (float3(_Norm3X , _Norm3Y , _Norm3Z));
				float3 temp_output_44_0_g250 = ( appendResult257 * abs( temp_output_167_0_g247 ) );
				float3 break14_g250 = temp_output_44_0_g250;
				float3 temp_output_36_0_g250 = temp_output_166_0_g247;
				float4 appendResult23_g250 = (float4(temp_output_44_0_g250 , 0.0));
				float4 appendResult24_g250 = (float4(temp_output_44_0_g250 , 1.0));
				...
				float3 normalizeResult6_g257 = normalize( ( ( cross( temp_output_10_0_g257 , temp_output_9_0_g257 ) * UnpackNormalScale( ( ( _UseNorm0 + _UseNorm1 + _UseNorm2 + _UseNorm3 ) > 0.0 ? ( ( ( ( (float)(int)_UseNorm0 > 0.0 ? ( ( ( ( break14_g253.x > 0.0 ? tex2D( _MainNorm, ( ( (temp_output_36_0_g253).yz * _MainNorm_ST.xy ) + _MainNorm_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g254.x ) + ( ( break14_g253.y > 0.0 ? tex2D( _MainNorm, ( ( (temp_output_36_0_g253).zx * _MainNorm_ST.xy ) + _MainNorm_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g254.y ) + ( ( break14_g253.z > 0.0 ? tex2D( _MainNorm, ( ( (temp_output_36_0_g253).xy * _MainNorm_ST.xy ) + _MainNorm_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g254.z ) + ( color20_g253 * break10_g254.w ) ) / ( break10_g254.x + break10_g254.y + break10_g254.z + break10_g254.w ) ) : float4( 0,0,0,0 ) ) * break10_g252.x ) + ( ( (float)(int)_UseNorm1 > 0.0 ? ( ( ( ( break14_g255.x > 0.0 ? tex2D( _Norm1, ( ( (temp_output_36_0_g255).yz * _Norm1_ST.xy ) + _Norm1_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g256.x ) + ( ( break14_g255.y > 0.0 ? tex2D( _Norm1, ( ( (temp_output_36_0_g255).zx * _Norm1_ST.xy ) + _Norm1_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g256.y ) + ( ( break14_g255.z > 0.0 ? tex2D( _Norm1, ( ( (temp_output_36_0_g255).xy * _Norm1_ST.xy ) + _Norm1_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g256.z ) + ( color20_g255 * break10_g256.w ) ) / ( break10_g256.x + break10_g256.y + break10_g256.z + break10_g256.w ) ) : float4( 0,0,0,0 ) ) * break10_g252.y ) + ( ( (float)(int)_UseNorm2 > 0.0 ? ( ( ( ( break14_g248.x > 0.0 ? tex2D( _Norm2, ( ( (temp_output_36_0_g248).yz * _Norm2_ST.xy ) + _Norm2_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g249.x ) + ( ( break14_g248.y > 0.0 ? tex2D( _Norm2, ( ( (temp_output_36_0_g248).zx * _Norm2_ST.xy ) + _Norm2_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g249.y ) + ( ( break14_g248.z > 0.0 ? tex2D( _Norm2, ( ( (temp_output_36_0_g248).xy * _Norm2_ST.xy ) + _Norm2_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g249.z ) + ( color20_g248 * break10_g249.w ) ) / ( break10_g249.x + break10_g249.y + break10_g249.z + break10_g249.w ) ) : float4( 0,0,0,0 ) ) * break10_g252.z ) + ( ( (float)(int)_UseNorm3 > 0.0 ? ( ( ( ( break14_g250.x > 0.0 ? tex2D( _Norm3, ( ( (temp_output_36_0_g250).yz * _Norm3_ST.xy ) + _Norm3_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g251.x ) + ( ( break14_g250.y > 0.0 ? tex2D( _Norm3, ( ( (temp_output_36_0_g250).zx * _Norm3_ST.xy ) + _Norm3_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g251.y ) + ( ( break14_g250.z > 0.0 ? tex2D( _Norm3, ( ( (temp_output_36_0_g250).xy * _Norm3_ST.xy ) + _Norm3_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g251.z ) + ( color20_g250 * break10_g251.w ) ) / ( break10_g251.x + break10_g251.y + break10_g251.z + break10_g251.w ) ) : float4( 0,0,0,0 ) ) * break10_g252.w ) ) / ( break10_g252.x + break10_g252.y + break10_g252.z + break10_g252.w ) ) : float4(0.5019608,0.5019608,1,1) ), 1.0 ).x ) + ( temp_output_10_0_g257 * UnpackNormalScale( ( ( _UseNorm0 + _UseNorm1 + _UseNorm2 + _UseNorm3 ) > 0.0 ? ( ( ( ( (float)(int)_UseNorm0 > 0.0 ? ( ( ( ( break14_g253.x > 0.0 ? tex2D( _MainNorm, ( ( (temp_output_36_0_g253).yz * _MainNorm_ST.xy ) + _MainNorm_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g254.x ) + ( ( break14_g253.y > 0.0 ? tex2D( _MainNorm, ( ( (temp_output_36_0_g253).zx * _MainNorm_ST.xy ) + _MainNorm_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g254.y ) + ( ( break14_g253.z > 0.0 ? tex2D( _MainNorm, ( ( (temp_output_36_0_g253).xy * _MainNorm_ST.xy ) + _MainNorm_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g254.z ) + ( color20_g253 * break10_g254.w ) ) / ( break10_g254.x + break10_g254.y + break10_g254.z + break10_g254.w ) ) : float4( 0,0,0,0 ) ) * break10_g252.x ) + ( ( (float)(int)_UseNorm1 > 0.0 ? ( ( ( ( break14_g255.x > 0.0 ? tex2D( _Norm1, ( ( (temp_output_36_0_g255).yz * _Norm1_ST.xy ) + _Norm1_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g256.x ) + ( ( break14_g255.y > 0.0 ? tex2D( _Norm1, ( ( (temp_output_36_0_g255).zx * _Norm1_ST.xy ) + _Norm1_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g256.y ) + ( ( break14_g255.z > 0.0 ? tex2D( _Norm1, ( ( (temp_output_36_0_g255).xy * _Norm1_ST.xy ) + _Norm1_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g256.z ) + ( color20_g255 * break10_g256.w ) ) / ( break10_g256.x + break10_g256.y + break10_g256.z + break10_g256.w ) ) : float4( 0,0,0,0 ) ) * break10_g252.y ) + ( ( (float)(int)_UseNorm2 > 0.0 ? ( ( ( ( break14_g248.x > 0.0 ? tex2D( _Norm2, ( ( (temp_output_36_0_g248).yz * _Norm2_ST.xy ) + _Norm2_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g249.x ) + ( ( break14_g248.y > 0.0 ? tex2D( _Norm2, ( ( (temp_output_36_0_g248).zx * _Norm2_ST.xy ) + _Norm2_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g249.y ) + ( ( break14_g248.z > 0.0 ? tex2D( _Norm2, ( ( (temp_output_36_0_g248).xy * _Norm2_ST.xy ) + _Norm2_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g249.z ) + ( color20_g248 * break10_g249.w ) ) / ( break10_g249.x + break10_g249.y + break10_g249.z + break10_g249.w ) ) : float4( 0,0,0,0 ) ) * break10_g252.z ) + ( ( (float)(int)_UseNorm3 > 0.0 ? ( ( ( ( break14_g250.x > 0.0 ? tex2D( _Norm3, ( ( (temp_output_36_0_g250).yz * _Norm3_ST.xy ) + _Norm3_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g251.x ) + ( ( break14_g250.y > 0.0 ? tex2D( _Norm3, ( ( (temp_output_36_0_g250).zx * _Norm3_ST.xy ) + _Norm3_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g251.y ) + ( ( break14_g250.z > 0.0 ? tex2D( _Norm3, ( ( (temp_output_36_0_g250).xy * _Norm3_ST.xy ) + _Norm3_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g251.z ) + ( color20_g250 * break10_g251.w ) ) / ( break10_g251.x + break10_g251.y + break10_g251.z + break10_g251.w ) ) : float4( 0,0,0,0 ) ) * break10_g252.w ) ) / ( break10_g252.x + break10_g252.y + break10_g252.z + break10_g252.w ) ) : float4(0.5019608,0.5019608,1,1) ), 1.0 ).y ) + ( temp_output_9_0_g257 * UnpackNormalScale( ( ( _UseNorm0 + _UseNorm1 + _UseNorm2 + _UseNorm3 ) > 0.0 ? ( ( ( ( (float)(int)_UseNorm0 > 0.0 ? ( ( ( ( break14_g253.x > 0.0 ? tex2D( _MainNorm, ( ( (temp_output_36_0_g253).yz * _MainNorm_ST.xy ) + _MainNorm_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g254.x ) + ( ( break14_g253.y > 0.0 ? tex2D( _MainNorm, ( ( (temp_output_36_0_g253).zx * _MainNorm_ST.xy ) + _MainNorm_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g254.y ) + ( ( break14_g253.z > 0.0 ? tex2D( _MainNorm, ( ( (temp_output_36_0_g253).xy * _MainNorm_ST.xy ) + _MainNorm_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g254.z ) + ( color20_g253 * break10_g254.w ) ) / ( break10_g254.x + break10_g254.y + break10_g254.z + break10_g254.w ) ) : float4( 0,0,0,0 ) ) * break10_g252.x ) + ( ( (float)(int)_UseNorm1 > 0.0 ? ( ( ( ( break14_g255.x > 0.0 ? tex2D( _Norm1, ( ( (temp_output_36_0_g255).yz * _Norm1_ST.xy ) + _Norm1_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g256.x ) + ( ( break14_g255.y > 0.0 ? tex2D( _Norm1, ( ( (temp_output_36_0_g255).zx * _Norm1_ST.xy ) + _Norm1_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g256.y ) + ( ( break14_g255.z > 0.0 ? tex2D( _Norm1, ( ( (temp_output_36_0_g255).xy * _Norm1_ST.xy ) + _Norm1_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g256.z ) + ( color20_g255 * break10_g256.w ) ) / ( break10_g256.x + break10_g256.y + break10_g256.z + break10_g256.w ) ) : float4( 0,0,0,0 ) ) * break10_g252.y ) + ( ( (float)(int)_UseNorm2 > 0.0 ? ( ( ( ( break14_g248.x > 0.0 ? tex2D( _Norm2, ( ( (temp_output_36_0_g248).yz * _Norm2_ST.xy ) + _Norm2_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g249.x ) + ( ( break14_g248.y > 0.0 ? tex2D( _Norm2, ( ( (temp_output_36_0_g248).zx * _Norm2_ST.xy ) + _Norm2_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g249.y ) + ( ( break14_g248.z > 0.0 ? tex2D( _Norm2, ( ( (temp_output_36_0_g248).xy * _Norm2_ST.xy ) + _Norm2_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g249.z ) + ( color20_g248 * break10_g249.w ) ) / ( break10_g249.x + break10_g249.y + break10_g249.z + break10_g249.w ) ) : float4( 0,0,0,0 ) ) * break10_g252.z ) + ( ( (float)(int)_UseNorm3 > 0.0 ? ( ( ( ( break14_g250.x > 0.0 ? tex2D( _Norm3, ( ( (temp_output_36_0_g250).yz * _Norm3_ST.xy ) + _Norm3_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g251.x ) + ( ( break14_g250.y > 0.0 ? tex2D( _Norm3, ( ( (temp_output_36_0_g250).zx * _Norm3_ST.xy ) + _Norm3_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g251.y ) + ( ( break14_g250.z > 0.0 ? tex2D( _Norm3, ( ( (temp_output_36_0_g250).xy * _Norm3_ST.xy ) + _Norm3_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g251.z ) + ( color20_g250 * break10_g251.w ) ) / ( break10_g251.x + break10_g251.y + break10_g251.z + break10_g251.w ) ) : float4( 0,0,0,0 ) ) * break10_g252.w ) ) / ( break10_g252.x + break10_g252.y + break10_g252.z + break10_g252.w ) ) : float4(0.5019608,0.5019608,1,1) ), 1.0 ).z ) ) );
...
/*ASEBEGIN
Version=18909
152;325.6;2060;711;782.5023;615.8806;1.297399;True;False
...
Node;AmplifyShaderEditor.FunctionNode;263;1152,-3808;Inherit;False;Mud Spherical Triplanar Texture Blend;-1;;247;d6579a9932e90eb4c8c7f58f55cbd31b;0;15;166;FLOAT3;0,0,0;False;167;FLOAT3;0,0,0;False;9;FLOAT4;1,0,0,0;False;4;INT;0;False;18;SAMPLER2D;0,0,0,0;False;165;FLOAT3;0,0,0;False;97;INT;0;False;96;SAMPLER2D;0,0,0,0;False;162;FLOAT3;0,0,0;False;105;INT;0;False;104;SAMPLER2D;0,0,0,0;False;163;FLOAT3;0,0,0;False;114;INT;0;False;115;SAMPLER2D;0,0,0,0;False;164;FLOAT3;0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;221;2944,-960;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;True;False;False;False;False;0;False;-1;False;False;False;False;False;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=DepthOnly;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;220;2944,-960;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;1;LightMode=ShadowCaster;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;222;2944,-960;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=B701D3258AEB8E7DC3944CE91E992C01B1AB3C66