	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 vertexToFrag27_g234 = temp_output_198_0;
				o.ase_texcoord13.xyz = vertexToFrag27_g234;
						 ...
						 ) : SV_Target
			{
				...
				float3 temp_output_44_0_g232 = ( appendResult238 * abs( vertexToFrag247 ) );
				float3 break14_g232 = temp_output_44_0_g232;
				float3 vertexToFrag246 = IN.ase_texcoord8.xyz;
				float3 temp_output_36_0_g232 = vertexToFrag246;
				float4 appendResult23_g232 = (float4(temp_output_44_0_g232 , 0.0));
				float4 appendResult24_g232 = (float4(temp_output_44_0_g232 , 1.0));
				float4 break10_g233 = ( ( break14_g232.x + break14_g232.y + break14_g232.z ) > 0.0 ? appendResult23_g232 : appendResult24_g232 );
				float4 color20_g232 = IsGammaSpace() ? float4(1,1,1,0) : float4(1,1,1,0);
				...
				float4 temp_output_175_0 = ( ( _UseTex0 > 0.0 ? ( ( ( ( break14_g232.x > 0.0 ? tex2D( _MainTex, ( ( (temp_output_36_0_g232).yz * _MainTex_ST.xy ) + _MainTex_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g233.x ) + ( ( break14_g232.y > 0.0 ? tex2D( _MainTex, ( ( (temp_output_36_0_g232).zx * _MainTex_ST.xy ) + _MainTex_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g233.y ) + ( ( break14_g232.z > 0.0 ? tex2D( _MainTex, ( ( (temp_output_36_0_g232).xy * _MainTex_ST.xy ) + _MainTex_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g233.z ) + ( color20_g232 * break10_g233.w ) ) / ( break10_g233.x + break10_g233.y + break10_g233.z + break10_g233.w ) ) : color182 ) * temp_output_25_0_g83 );
				
				float3 vertexToFrag257 = IN.ase_texcoord10.xyz;
				float3 temp_output_10_0_g237 = vertexToFrag257;
				float3 temp_output_9_0_g237 = vertexToFrag247;
				float3 appendResult251 = (float3(_MainNormX , _MainNormY , _MainNormZ));
				float3 temp_output_44_0_g235 = ( appendResult251 * abs( vertexToFrag247 ) );
				float3 break14_g235 = temp_output_44_0_g235;
				float3 temp_output_36_0_g235 = vertexToFrag246;
				float4 appendResult23_g235 = (float4(temp_output_44_0_g235 , 0.0));
				float4 appendResult24_g235 = (float4(temp_output_44_0_g235 , 1.0));
				float4 break10_g236 = ( ( break14_g235.x + break14_g235.y + break14_g235.z ) > 0.0 ? appendResult23_g235 : appendResult24_g235 );
				float4 color20_g235 = IsGammaSpace() ? float4(1,1,1,0) : float4(1,1,1,0);
				float3 normalizeResult6_g237 = normalize( ( ( cross( temp_output_10_0_g237 , temp_output_9_0_g237 ) * UnpackNormalScale( ( _UseNorm0 > 0.0 ? ( ( ( ( break14_g235.x > 0.0 ? tex2D( _MainNorm, ( ( (temp_output_36_0_g235).yz * _MainNorm_ST.xy ) + _MainNorm_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g236.x ) + ( ( break14_g235.y > 0.0 ? tex2D( _MainNorm, ( ( (temp_output_36_0_g235).zx * _MainNorm_ST.xy ) + _MainNorm_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g236.y ) + ( ( break14_g235.z > 0.0 ? tex2D( _MainNorm, ( ( (temp_output_36_0_g235).xy * _MainNorm_ST.xy ) + _MainNorm_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g236.z ) + ( color20_g235 * break10_g236.w ) ) / ( break10_g236.x + break10_g236.y + break10_g236.z + break10_g236.w ) ) : float4(0.5019608,0.5019608,1,1) ), 1.0 ).x ) + ( temp_output_10_0_g237 * UnpackNormalScale( ( _UseNorm0 > 0.0 ? ( ( ( ( break14_g235.x > 0.0 ? tex2D( _MainNorm, ( ( (temp_output_36_0_g235).yz * _MainNorm_ST.xy ) + _MainNorm_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g236.x ) + ( ( break14_g235.y > 0.0 ? tex2D( _MainNorm, ( ( (temp_output_36_0_g235).zx * _MainNorm_ST.xy ) + _MainNorm_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g236.y ) + ( ( break14_g235.z > 0.0 ? tex2D( _MainNorm, ( ( (temp_output_36_0_g235).xy * _MainNorm_ST.xy ) + _MainNorm_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g236.z ) + ( color20_g235 * break10_g236.w ) ) / ( break10_g236.x + break10_g236.y + break10_g236.z + break10_g236.w ) ) : float4(0.5019608,0.5019608,1,1) ), 1.0 ).y ) + ( temp_output_9_0_g237 * UnpackNormalScale( ( _UseNorm0 > 0.0 ? ( ( ( ( break14_g235.x > 0.0 ? tex2D( _MainNorm, ( ( (temp_output_36_0_g235).yz * _MainNorm_ST.xy ) + _MainNorm_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g236.x ) + ( ( break14_g235.y > 0.0 ? tex2D( _MainNorm, ( ( (temp_output_36_0_g235).zx * _MainNorm_ST.xy ) + _MainNorm_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g236.y ) + ( ( break14_g235.z > 0.0 ? tex2D( _MainNorm, ( ( (temp_output_36_0_g235).xy * _MainNorm_ST.xy ) + _MainNorm_ST.zw ) ) : float4( 0,0,0,0 ) ) * break10_g236.z ) + ( color20_g235 * break10_g236.w ) ) / ( break10_g236.x + break10_g236.y + break10_g236.z + break10_g236.w ) ) : float4(0.5019608,0.5019608,1,1) ), 1.0 ).z ) ) );
				...
				float localComputeOpaqueTransparency20_g234 = ( 0.0 );
				...
				float2 ScreenPos20_g234 = (( ( computeScreenPos3_g84 / (computeScreenPos3_g84).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g234 = IN.ase_texcoord13.xyz;
				float3 VertPos20_g234 = vertexToFrag27_g234;
				float localMudBunMeshPoint4_g83 = ( 0.0 );
				...
				float Hash20_g234 = (EmissionHash4_g83).w;
				float AlphaIn20_g234 = (temp_output_25_0_g83).a;
				float AlphaOut20_g234 = 0;
				float AlphaThreshold20_g234 = 0;
				sampler2D DitherNoiseTexture20_g234 = _DitherTexture;
				int DitherNoiseTextureSize20_g234 = _DitherTextureSize;
				int UseRandomDither20_g234 = (int)_RandomDither;
				float AlphaCutoutThreshold20_g234 = _AlphaCutoutThreshold;
				float DitherBlend20_g234 = _Dithering;
				{
				float alpha = AlphaIn20_g234;
				computeOpaqueTransparency(ScreenPos20_g234, VertPos20_g234, Hash20_g234, DitherNoiseTexture20_g234, DitherNoiseTextureSize20_g234, UseRandomDither20_g234 > 0, AlphaCutoutThreshold20_g234, DitherBlend20_g234,  alpha, AlphaThreshold20_g234);
				AlphaOut20_g234 = alpha;
				}
				
				float3 Albedo = temp_output_175_0.xyz;
				float3 Normal = normalizeResult6_g237;
				...
				float Occlusion = 1;
				float Alpha = ( (temp_output_175_0).w * AlphaOut20_g234 );
				float AlphaClipThreshold = AlphaThreshold20_g234;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				float3 vertexToFrag27_g234 = temp_output_198_0;
				o.ase_texcoord6.xyz = vertexToFrag27_g234;
						 ...
						 ) : SV_TARGET
			{
				...
				float4 computeScreenPos3_g84 = ComputeScreenPos( unityObjectToClipPos1_g84 );
				float2 ScreenPos20_g234 = (( ( computeScreenPos3_g84 / (computeScreenPos3_g84).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g234 = IN.ase_texcoord6.xyz;
				float3 VertPos20_g234 = vertexToFrag27_g234;
				float localMudBunMeshPoint4_g83 = ( 0.0 );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 vertexToFrag27_g234 = temp_output_198_0;
				o.ase_texcoord7.xyz = vertexToFrag27_g234;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 computeScreenPos3_g84 = ComputeScreenPos( unityObjectToClipPos1_g84 );
				float2 ScreenPos20_g234 = (( ( computeScreenPos3_g84 / (computeScreenPos3_g84).w ) * _ScreenParams )).xy;
				float3 vertexToFrag27_g234 = IN.ase_texcoord7.xyz;
				float3 VertPos20_g234 = vertexToFrag27_g234;
				float localMudBunMeshPoint4_g83 = ( 0.0 );
				int VertexID4_g83 = IN.ase_texcoord2.w;
				float3 PositionWs4_g83 = float3( 0,0,0 );
...
/*ASEBEGIN
Version=18909
192;228.8;2060;711;-867.4908;560.7808;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;245;768,-512;Inherit;False;Mud Triplanar Sample;-1;;232;d9088f0d6015c424b98757b174010394;0;5;36;FLOAT3;0,0,0;False;37;FLOAT3;0,0,0;False;3;SAMPLER2D;0,0,0;False;26;SAMPLERSTATE;0,0,0;False;11;FLOAT3;0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;258;1664,-1280;Inherit;False;URP Normal Helper;-1;;237;ac9d436fdaef92c469abf91a59be3ca9;0;3;8;FLOAT4;0,0,0,0;False;9;FLOAT3;0,0,0;False;10;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;253;768,-1056;Inherit;False;Mud Triplanar Sample;-1;;235;d9088f0d6015c424b98757b174010394;0;5;36;FLOAT3;0,0,0;False;37;FLOAT3;0,0,0;False;3;SAMPLER2D;0,0,0;False;26;SAMPLERSTATE;0,0,0;False;11;FLOAT3;0,0,0;False;1;FLOAT4;0
...
ASEEND*/
//CHKSM=1C1619A3AC5BF62394B61B39F1ED1A6CACF0C931