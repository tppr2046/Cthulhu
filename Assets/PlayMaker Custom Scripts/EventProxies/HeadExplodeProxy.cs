...
namespace com.headexplode
{
	public class HeadExplodeProxy : PlayMakerEventProxy {

		[Button("HeadExplode","Test : HeadExplode")] public bool _;
		public void HeadExplode()
		{
			if (debug || !Application.isPlaying)
			{
				Debug.Log("HeadExplodeProxy : HeadExplode()");
			}
