...
namespace com.fistattack
{
	public class FistAttackProxy : PlayMakerEventProxy {

		[Button("FistAttack","Test : FistAttack")] public bool _;
		public void FistAttack()
		{
			if (debug || !Application.isPlaying)
			{
				Debug.Log("FistAttackProxy : FistAttack()");
			}
