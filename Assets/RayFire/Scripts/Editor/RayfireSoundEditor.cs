...
namespace RayFire
{
    ...
    public class RayfireSoundEditor : Editor
    {
        ...
        void UI_PropsInit()
        {
            ...
            UI_Properties (sound.initialization);
        ...
        void UI_PropsAct()
        {
            ...
            UI_Properties (sound.activation);
        ...
        void UI_PropsDml()
        {
            ...
            UI_Properties (sound.demolition);
        ...
        void UI_Properties(RFSound snd)
        {
            EditorGUI.BeginChangeCheck();
            ...
            if (EditorGUI.EndChangeCheck() == true)
            {
                foreach (RayfireSound scr in targets)
                {
                    snd.outputGroup = snd.outputGroup;
                    SetDirty (scr);
                }
            }
