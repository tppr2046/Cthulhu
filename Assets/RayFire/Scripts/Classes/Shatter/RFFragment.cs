...
namespace RayFire
{
    ...
    public static class RFFragment
    {
        ...
        public static void CacheMeshes(ref Mesh[] meshes, ref Vector3[] pivots, ref RFDictionary[] rfOrigSubMeshIds, RayfireShatter scrShatter)
        {
            ...
            RemovePlanar (ref meshes, ref pivots, ref rfOrigSubMeshIds, scrShatter);
        
            // Filter out meshes by size
            RemoveBySize (ref meshes, ref pivots, ref rfOrigSubMeshIds, scrShatter);
        ...
        // Filter out planar meshes
        static void RemovePlanar (ref Mesh[] meshes, ref Vector3[] pivots, ref RFDictionary[] origSubMeshIdsRf, RayfireShatter scrShatter)
        {
        ...
        // Filter out meshes by size
        static void RemoveBySize (ref Mesh[] meshes, ref Vector3[] pivots, ref RFDictionary[] origSubMeshIdsRf, RayfireShatter scr)
        {
